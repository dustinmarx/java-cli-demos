# java-cli-demos
This is a collection of simple Java classes that demonstrate several (28 as of November 2017) Java-based command-line parsing libraries. The libraries are listed here in the order in which they were covered on the "Inspired by Actual Events" blog (http://marxsoftware.blogspot.com/). Note that the ordered of the presented Java-based command line parsing libraries is not significant other than that it's the order the libraries were presented on the blog. In addition to the posts below on individual libraries available for parsing command line arguments, there is a post in this series on writing one's own command line parsing code [(Part 29: Do It Youself)](http://marxsoftware.blogspot.com/2017/10/diy-commandline.html) and a post providing a summary of observations that can be made from this series [(Part 30: Observations)](http://marxsoftware.blogspot.com/2017/11/java-cmd-line-observations.html).
